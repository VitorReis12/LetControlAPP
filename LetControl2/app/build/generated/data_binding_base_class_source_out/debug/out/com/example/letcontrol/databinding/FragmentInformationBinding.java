...
public final class FragmentInformationBinding implements ViewBinding {
  ...
  private FragmentInformationBinding(@NonNull FrameLayout rootView, @NonNull TextView textView) {
  ...
  public static FragmentInformationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInformationBinding((FrameLayout) rootView, textView);
    }
